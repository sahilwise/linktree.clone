...
<div className="grid sm:grid-cols-3 px-8 sm:px-32 bg-transparent gap-y-8 sm:gap-x-8">
       ...
       <div className='flex flex-row items-center space-x-3'>
           ...
           <span className='text-base text-white font-black'>Aclope</span>
       </div>
       ...
       <button className='flex items-center justify-center text-xs font-medium rounded-full px-4 py-1 space-x-1 bg-red-600 hover:text-white text-white dark:bg-slate-800 dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black'>
           <span>Closed ▼</span>
           </button>
       </div>
       </div>
   {/* INSIDE */}       
       ...
       <div className='flex flex-row items-center space-x-3'>
           ...
           <span className='text-base text-white font-black'>Acedys</span>
       </div>
       <div className="text-neutral-700"> 
       Convert your website to a mobile app.
       Convert your website to a mobile app.
   ...
   {/* INSIDE */}    
           ...
           <span className='text-base text-white font-black'>Addify</span>
       </div>
       <div className="text-neutral-700"> 
       Convert your website to a mobile app.
       Convert your website to a mobile app.
